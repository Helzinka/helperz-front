			...
			<View style={styles.content}>
				...
				>
					...
					<View style={styles.textCard}>
						<Text style={styles.titreCard}>Vous êtes sur le point de faire un achat ?</Text>
						<Text style={styles.textContent}>
							Créez une annonce dès maintenant afin de trouver un.e Helperz qui vous accompagnera lors de
							votre achat
						</Text>
					</View>
				</TouchableOpacity>
				...
				>
					...
					/>
					<View style={styles.textCard}>
						<Text style={styles.titreCard}>Trouvez un Helperz proche de votre annonce</Text>
						<Text style={styles.textContent}>
				...
				>
					...
					/>
					<View style={styles.textCard}>
						<Text style={styles.titreCard}>Faites vous rémunérer pour votre expertise</Text>
						<Text style={styles.textContent}>
							Donnez un coup de main pour aider quelqu'un à ne pas se tromper sur son prochain achat
						</Text>
					</View>
				</TouchableOpacity>
			</View>
